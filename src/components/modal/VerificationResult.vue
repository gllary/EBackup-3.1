      ...
      <template>
        <el-table
          ...
          <el-table-column
            ...
            width="">
            <template slot-scope="scope">
              <el-row class="source_row">{{scope.row.source.hostName}}</el-row>
              <el-row class="target_row">{{scope.row.target.hostName}}</el-row>
            </template>
          </el-table-column>
          <el-table-column
            prop="date"
            ...
            width="">
            <template slot-scope="scope">
              <el-row class="source_row">{{scope.row.source.hostIp}}</el-row>
              <el-row class="target_row">{{scope.row.target.hostIp}}</el-row>
            </template>
          </el-table-column>
          <el-table-column
            prop="date"
            ...
            width="">
            <template slot-scope="scope">
              <el-row class="source_row">{{scope.row.source.dbName}}</el-row>
              <el-row class="target_row">{{scope.row.target.dbName}}</el-row>
            </template>
          </el-table-column>
          <el-table-column
            prop="date"
            ...
            width="">
            <template slot-scope="scope">
              <el-row class="source_row">{{scope.row.source.dbCapacity |capacityFmt}}</el-row>
              <el-row class="target_row">{{scope.row.target.dbCapacity |capacityFmt}}</el-row>
            </template>
          </el-table-column>
          <el-table-column
            prop="date"
            ...
            width="">
            <template slot-scope="scope">
              <el-row class="source_row">{{scope.row.source.tablesNumber}}</el-row>
              <el-row class="target_row">{{scope.row.target.tablesNumber}}</el-row>
            </template>
          </el-table-column>
          <el-table-column
            prop="date"
            ...
            width="">
            <template slot-scope="scope">
              <el-row class="source_row">{{scope.row.source.recordNumber}}</el-row>
              <el-row class="target_row">{{scope.row.target.recordNumber}}</el-row>
            </template>
          </el-table-column>
          <el-table-column
            prop="result"
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      this.loading = true;
      getRestoreVerificationResultList(this.id).then(res => {
