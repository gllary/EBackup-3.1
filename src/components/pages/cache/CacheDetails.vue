...
import BackupPlanModal from '@/components/pages/cache/BackupPlanModal';
import RestorePlanModal from '@/components/pages/cache/RestorePlanModal';
import SingleRestoreModal from '@/components/pages/cache/SingleRestoreModal';
import BackupCard from '@/components/pages/cache/BackupCard';
import BackupResultList from '@/components/pages/cache/BackupResultList';
import RestoreCard from '@/components/pages/cache/RestoreCard';
import RestoreRecords from '@/components/pages/cache/RestoreRecords';
export default {
  name: 'CacheDetails',
