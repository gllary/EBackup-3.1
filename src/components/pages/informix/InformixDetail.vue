...
import BackupPlanModal from '@/components/pages/informix/BackupPlanModal';
import RestorePlanModal from '@/components/pages/informix/RestorePlanModal';
import SingleRestoreModal from '@/components/pages/informix/SingleRestoreModal';
import BackupCard from '@/components/pages/informix/BackupCard';
import BackupResultList from '@/components/pages/informix/BackupResultList';
import RestoreCard from '@/components/pages/informix/RestoreCard';
import RestoreRecords from '@/components/pages/informix/RestoreRecords';
export default {
  name: 'InformixDetail',
