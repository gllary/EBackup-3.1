...
import BackupPlanModal from '@/components/pages/sybase/BackupPlanModal';
import RestorePlanModal from '@/components/pages/sybase/RestorePlanModal';
import SingleRestoreModal from '@/components/pages/sybase/SingleRestoreModal';
import BackupCard from '@/components/pages/sybase/BackupCard';
import BackupResultList from '@/components/pages/sybase/BackupResultList';
import RestoreCard from '@/components/pages/sybase/RestoreCard';
import RestoreRecords from '@/components/pages/sybase/RestoreRecords';
export default {
  name: 'SybaseDetails',
