...
import BackupPlanModal from '@/components/pages/postgresql/BackupPlanModal';
import RestorePlanModal from '@/components/pages/postgresql/RestorePlanModal';
import SingleRestoreModal from '@/components/pages/postgresql/SingleRestoreModal';
import BackupCard from '@/components/pages/postgresql/BackupCard';
import BackupResultList from '@/components/pages/postgresql/BackupResultList';
import RestoreCard from '@/components/pages/postgresql/RestoreCard';
import RestoreRecords from '@/components/pages/postgresql/RestoreRecords';
export default {
